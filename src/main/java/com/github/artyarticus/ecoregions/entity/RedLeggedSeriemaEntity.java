...
public class RedLeggedSeriemaEntity extends ZawaLandEntity implements OviparousEntity {
    public RedLeggedSeriemaEntity(EntityType<? extends ZawaLandEntity> type, World world) {
        super(type, world);
    }
    ...
    public AgeableEntity getBreedOffspring(ServerWorld world, AgeableEntity entity) {
        return EcoRegionsEntities.RED_LEGGED_SERIEMA.get().create(world);
    }
