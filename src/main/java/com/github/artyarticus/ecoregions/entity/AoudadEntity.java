...
public class AoudadEntity extends ZawaLandEntity {
    public AoudadEntity(EntityType<? extends ZawaLandEntity> type, World world) {
        super(type, world);
    }
    ...
    public AgeableEntity getBreedOffspring(ServerWorld world, AgeableEntity entity) {
        return EcoRegionsEntities.AOUDAD.get().create(world);
    }
