...
public class GibbonEntity extends ZawaLandEntity implements SpeciesVariantsEntity, ClimbingEntity {
    public static final EntityDataAccessor<Boolean> CLIMBING;

    public GibbonEntity(EntityType<? extends ZawaLandEntity> type, Level world) {
        super(type, world);
    }
    ...
    public AgeableMob getBreedOffspring(ServerLevel world, AgeableMob entity) {
        return EcoRegionsEntities.GIBBON.get().create(world);
    }
    ...
    static {
        CLIMBING = SynchedEntityData.defineId(GibbonEntity.class, EntityDataSerializers.BOOLEAN);
    }
}
