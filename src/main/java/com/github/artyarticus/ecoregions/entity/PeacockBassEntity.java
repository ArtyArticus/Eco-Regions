...
public class PeacockBassEntity extends ZawaAmbientFishEntity {
    public PeacockBassEntity(EntityType<? extends ZawaAmbientFishEntity> type, World world) {
        super(type, world);
    }
    ...
    protected ItemStack getBucketItemStack() {
        return new ItemStack(EcoRegionsItems.PEACOCK_BASS_BUCKET.get());
    }
    ...
    public AgeableEntity getBreedOffspring(ServerWorld world, AgeableEntity entity) {
        return EcoRegionsEntities.PEACOCK_BASS.get().create(world);
    }
