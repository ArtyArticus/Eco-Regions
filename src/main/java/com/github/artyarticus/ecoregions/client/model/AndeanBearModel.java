...
public abstract class AndeanBearModel extends ZawaBaseModel<AndeanBearEntity> {
    ...
    public static class Adult extends AndeanBearModel {
        ...
        @Override
        public void setupAnim(AndeanBearEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    public static class Child extends AndeanBearModel {
