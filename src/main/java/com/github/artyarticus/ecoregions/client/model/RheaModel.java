...
public abstract class RheaModel extends ZawaBaseModel<RheaEntity> {
    ...
    public static class Adult extends RheaModel {
        ...
        public Adult() {
            ...
            this.Head.addBox(-1.5F, -1.5F, -2.0F, 3.0F, 3.0F, 4.0F, 0.01F, 0.0F, 0.0F);
            ...
            this.WingRight.addBox(-0.5F, -2.0F, 0.0F, 2.0F, 9.0F, 10.0F, 0.0F, 0.0F, 0.0F);
            ...
            this.WingLeft.addBox(-1.5F, -2.0F, 0.0F, 2.0F, 9.0F, 10.0F, 0.0F, 0.0F, 0.0F);
        ...
        public void playIdleAnimation(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
            ...
            this.Neck1.xRot = MathHelper.cos(2.0F + limbSwing * speed * 0.1F) * limbSwingAmount * (degree * 0.2F) * 0.2F + 0.865F;
            this.Head.xRot = MathHelper.cos(2.0F + limbSwing * speed * 0.1F) * limbSwingAmount * (degree * 0.2F) * 0.2F + 1.403F;
            this.Tail1.xRot = MathHelper.cos(2.0F + limbSwing * speed * 0.1F) * limbSwingAmount * (degree * 0.2F) * 0.2F - 0.501F;
            this.Tail2.xRot = MathHelper.cos(2.0F + limbSwing * speed * 0.1F) * limbSwingAmount * (degree * 0.2F) * 0.2F - 0.455F;        }
