...
public abstract class LorisModel extends ZawaBaseModel<LorisEntity> {
    ...
    public static class Child extends LorisModel {
        ...
        public Child() {
            ...
            this.Snout.setPos(0.0F, 0.4F, -1.4F);
            this.Snout.addBox(-0.5F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F, 0.4F, 0.0F, 0.0F);
            this.setRotateAngle(Snout, 0.3522074483787779F, 0.0F, 0.0F);
            this.PygmyEarLeft = new ModelRenderer(this, 20, 0);
            this.PygmyEarLeft.mirror = true;
            this.PygmyEarLeft.setPos(1.4F, -0.7F, -0.2F);
            this.PygmyEarLeft.addBox(-0.5F, -1.0F, 0.0F, 1.0F, 2.0F, 1.0F, 0.0F, -0.2F, 0.0F);
            this.setRotateAngle(PygmyEarLeft, 0.0F, -0.35185837453889574F, 0.3909537457888271F);
            this.CheekLeft = new ModelRenderer(this, 18, 5);
            this.CheekLeft.setPos(1.0F, 0.6F, -0.05F);
            this.CheekLeft.addBox(-0.5F, 0.0F, -1.0F, 1.0F, 1.0F, 2.0F, -0.1F, -0.1F, -0.1F);
            this.setRotateAngle(CheekLeft, 0.0F, 0.0F, -0.19547687289441354F);
            ...
            this.Head.addBox(-1.5F, -1.5F, -1.0F, 3.0F, 3.0F, 2.0F, -0.1F, -0.2F, -0.1F);
            this.setRotateAngle(Head, 0.27366763203903305F, 0.0F, 0.0F);
            this.Mouth = new ModelRenderer(this, 28, 3);
            this.Mouth.setPos(0.0F, 1.0F, 1.0F);
            this.Mouth.addBox(-0.5F, -0.4F, -0.95F, 1.0F, 1.0F, 1.0F, 0.29F, 0.0F, 0.0F);
            this.setRotateAngle(Mouth, -0.1563815016444822F, 0.0F, 0.0F);
            ...
            this.Hip.setPos(0.0F, -1.0F, 1.0F);
            this.Hip.addBox(-1.5F, -0.5F, -0.2F, 3.0F, 3.0F, 2.0F, 0.1F, 0.0F, 0.0F);
            this.setRotateAngle(Hip, -0.2923426497090502F, 0.0F, 0.0F);
            this.Nose = new ModelRenderer(this, 24, 5);
            this.Nose.setPos(0.0F, 0.0F, -0.3F);
            this.Nose.addBox(-0.5F, 0.0F, -0.2F, 1.0F, 1.0F, 2.0F, 0.0F, 0.0F, -0.2F);
            this.setRotateAngle(Nose, 0.27366763203903305F, 0.0F, 0.0F);
            this.CheekRight = new ModelRenderer(this, 18, 5);
            this.CheekRight.setPos(-1.0F, 0.6F, -0.05F);
            this.CheekRight.addBox(-0.5F, 0.0F, -1.0F, 1.0F, 1.0F, 2.0F, -0.1F, -0.1F, -0.1F);
            this.setRotateAngle(CheekRight, 0.0F, 0.0F, 0.19547687289441354F);
            ...
            this.HandRight.setPos(0.0F, 0.9F, 0.0F);
            this.HandRight.addBox(-0.5F, -0.5F, -0.6F, 1.0F, 1.0F, 1.0F, 0.1F, 0.0F, 0.0F);
            ...
            this.Neck.addBox(-1.0F, -1.0F, -1.0F, 2.0F, 3.0F, 2.0F, 0.0F, -0.2F, 0.0F);
            ...
            this.PygmyEarRight.setPos(-1.4F, -0.7F, -0.2F);
            this.PygmyEarRight.addBox(-0.5F, -1.0F, 0.0F, 1.0F, 2.0F, 1.0F, 0.0F, -0.2F, 0.0F);
            this.setRotateAngle(PygmyEarRight, 0.0F, 0.35185837453889574F, -0.3909537457888271F);
            ...
            this.FootRight.setPos(0.0F, 2.3F, 0.3F);
            this.FootRight.addBox(-0.5F, -0.5F, -1.3F, 1.0F, 1.0F, 2.0F, 0.1F, 0.0F, 0.0F);
            ...
            this.FootLeft.setPos(0.0F, 2.3F, 0.3F);
            this.FootLeft.addBox(-0.5F, -0.5F, -1.3F, 1.0F, 1.0F, 2.0F, 0.1F, 0.0F, 0.0F);
            this.setRotateAngle(FootLeft, -0.2988003825888152F, 0.0F, 0.0F);
            this.HandLeft = new ModelRenderer(this, 0, 12);
            this.HandLeft.setPos(0.0F, 0.9F, 0.0F);
            this.HandLeft.addBox(-0.5F, -0.5F, -0.6F, 1.0F, 1.0F, 1.0F, 0.1F, 0.0F, 0.0F);
