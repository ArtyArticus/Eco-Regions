...
public abstract class BeeEaterModel extends ZawaBaseModel<BeeEaterEntity> {
    ...
    public static class Adult extends BeeEaterModel {
        ...
        public Adult() {
            ...
            this.TailEndRight.addBox(-0.5F, 0.0F, -0.5F, 1.0F, 4.0F, 0.0F, 0.0F, 0.0F, 0.0F);
            ...
            this.Neck1.addBox(-1.5F, -3.0F, -2.0F, 3.0F, 3.0F, 2.0F, 0.0F, 0.0F, 0.0F);
            ...
            this.TailEndLeft.addBox(-0.5F, 0.0F, -0.5F, 1.0F, 4.0F, 0.0F, 0.0F, 0.0F, 0.0F);
            ...
            this.TailEnd.addBox(-0.5F, 0.0F, -1.0F, 1.0F, 3.0F, 1.0F, 0.0F, 0.0F, 0.0F);
            this.setRotateAngle(TailEnd, 0.11728612207217244F, 0.0F, 0.0F);
            this.BeakBottom = new ModelRenderer(this, 21, 0);
            this.BeakBottom.setPos(-0.01F, 0.5F, 0.1F);
            this.BeakBottom.addBox(-0.5F, -0.5F, -3.0F, 1.0F, 1.0F, 3.0F, 0.0F, 0.0F, 0.0F);
        ...
        public void playIdleAnimation(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
            float speed = 1.0f;
            float degree = 1.0f;
            this.Neck1.xRot = MathHelper.cos(2.0F + limbSwing * speed * 0.1F) * limbSwingAmount * (degree * -0.3F) * 0.5F - 0.625F;
            this.Neck2.xRot = MathHelper.cos(2.0F + limbSwing * speed * 0.1F) * limbSwingAmount * (degree * 0.1F) * 0.5F - 0.586F;
            this.Head.xRot = MathHelper.cos(4.0F + limbSwing * speed * 0.1F) * limbSwingAmount * (degree * -0.15F) * 0.5F + 1.876F;
            this.TailBase.xRot = MathHelper.cos(4.0F + limbSwing * speed * 0.1F) * limbSwingAmount * (degree * -0.15F) * 0.5F + 1.622F;
        }
