...
public abstract class SlowLorisModel extends ZawaBaseModel<SlowLorisEntity> {
    ...
    public static class Adult extends SlowLorisModel {
        ...
        @Override
        public void setupAnim(SlowLorisEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        public void playMovementAnimation(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
            float speed = 5.5F;
            float degree = 0.8F;
                this.UpperArmLeft.xRot = MathHelper.cos(limbSwing * speed * 0.1F + 3.1415927F) * degree * 2.0F * limbSwingAmount * 0.5F + 0.16F;
                this.LowerArmLeft.xRot = MathHelper.cos(4.0F + limbSwing * speed * 0.1F + 3.1415927F) * degree * -1.5F * limbSwingAmount * 0.5F - 0.63F;
                this.HandLeft.xRot = MathHelper.cos(5.0F + limbSwing * speed * 0.1F + 3.1415927F) * degree * -2.0F * limbSwingAmount * 0.5F + 0.47F;
                this.UpperArmRight.xRot = MathHelper.cos(limbSwing * speed * 0.1F + 3.1415927F) * degree * -2.0F * limbSwingAmount * 0.5F + 0.16F;
                this.LowerArmRight.xRot = MathHelper.cos(4.0F + limbSwing * speed * 0.1F + 3.1415927F) * degree * 1.5F * limbSwingAmount * 0.5F - 0.63F;
                this.HandRight.xRot = MathHelper.cos(5.0F + limbSwing * speed * 0.1F + 3.1415927F) * degree * 2.0F * limbSwingAmount * 0.5F + 0.47F;

                this.ThighLeft.xRot = MathHelper.cos(1.0F + limbSwing * speed * 0.1F + 3.1415927F) * degree * -2.0F * limbSwingAmount * 0.5F + 0.43F;
                this.LegLeft.xRot = MathHelper.cos(5.0F + limbSwing * speed * 0.1F + 3.1415927F) * degree * -3.0F * limbSwingAmount * 0.5F + 0.43F;
                this.FootLeft.xRot = MathHelper.cos(1.0F + limbSwing * speed * 0.1F + 3.1415927F) * degree * 1.5F * limbSwingAmount * 0.5F - 0.23F;
                this.ThighRight.xRot = MathHelper.cos(1.0F + limbSwing * speed * 0.1F + 3.1415927F) * degree * 2.0F * limbSwingAmount * 0.5F + 0.43F;
                this.LegRight.xRot = MathHelper.cos(5.0F + limbSwing * speed * 0.1F + 3.1415927F) * degree * 3.0F * limbSwingAmount * 0.5F + 0.43F;
                this.FootRight.xRot = MathHelper.cos(1.0F + limbSwing * speed * 0.1F + 3.1415927F) * degree * -1.5F * limbSwingAmount * 0.5F - 0.23F;

                this.Chest.xRot = MathHelper.cos(2.0F + limbSwing * speed * 0.6F + 3.1415927F) * degree * 0.15F * limbSwingAmount * 0.5F + (this.isSwimming ? -0.15F : +0.04F);
                this.Neck.xRot = MathHelper.cos(limbSwing * speed * 0.0F + 3.1415927F) * degree * 0.0F * limbSwingAmount * 0.5F - 0.27F;

                this.Tail.xRot = MathHelper.cos(5.0F + limbSwing * speed * 0.6F + 3.1415927F) * degree * 0.15F * limbSwingAmount * 0.5F + (this.isSwimming ? 0.15F : +0.39F);
            }
        }

    public static class Child extends SlowLorisModel {
