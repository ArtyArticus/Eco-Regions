...
public abstract class CommonWombatModel extends ZawaBaseModel<CommonWombatEntity> {
    ...
    public static class Adult extends CommonWombatModel {
        ...
        public void playMovementAnimation(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float HeadPitch) {
            ...
            this.Chest.zRot = MathHelper.cos(limbSwing * speed * 0.3F) * degree * 0.4F * limbSwingAmount;
            ...
            this.ArmLeft.xRot = MathHelper.cos(limbSwing * speed * 0.3F) * degree * 2.0F * limbSwingAmount + 0.078F;
            this.ForearmLeft.xRot = MathHelper.cos(1.0F + limbSwing * speed * 0.3F) * degree * 1.5F * limbSwingAmount + -0.469F;
            this.HandLeft.xRot = MathHelper.cos(0.5F + limbSwing * speed * 0.3F) * degree * -1.5F * limbSwingAmount + 0.273F;
            this.ArmRight.xRot = MathHelper.cos(limbSwing * speed * 0.3F) * degree * -2.0F * limbSwingAmount + 0.078F;
            this.ForearmRight.xRot = MathHelper.cos(1.0F + limbSwing * speed * 0.3F) * degree * -1.5F * limbSwingAmount + -0.469F;
            this.HandRight.xRot = MathHelper.cos(0.5F + limbSwing * speed * 0.3F) * degree * 1.5F * limbSwingAmount + 0.273F;
            this.ThighLeft.xRot = MathHelper.cos(limbSwing * speed * 0.3F) * degree * 1.0F * limbSwingAmount + 0.234F;
            this.LegLeft.xRot = MathHelper.cos(1.5F + limbSwing * speed * 0.3F) * degree * 2.0F * limbSwingAmount + 0.625F;
            this.FootLeft.xRot = MathHelper.cos(limbSwing * speed * 0.3F) * degree * -1.0F * limbSwingAmount + -0.469F;
            this.ThighRight.xRot = MathHelper.cos(limbSwing * speed * 0.3F) * degree * -1.0F * limbSwingAmount + 0.234F;
            this.LegRight.xRot = MathHelper.cos(1.5F + limbSwing * speed * 0.3F) * degree * -2.0F * limbSwingAmount + 0.625F;
            this.FootRight.xRot = MathHelper.cos(limbSwing * speed * 0.3F) * degree * 1.0F * limbSwingAmount + -0.469F;
    ...
    public static class Child extends CommonWombatModel {
        ...
        public Child() {
            ...
            this.setRotateAngle(LegRight, 0.6250000322626381F, 0.0F, 0.0F);
            ...
            this.setRotateAngle(Bridge, 0.27314400463445304F, 0.0F, 0.0F);
            this.Neck = new ModelRenderer(this, 0, 12);
            this.Neck.setPos(0.0F, -1.2F, -1.6F);
            this.Neck.addBox(-1.5F, -0.5F, -1.5F, 3.0F, 3.0F, 3.0F, 0.0F, 0.0F, 0.0F);
            this.setRotateAngle(Neck, -0.010999999629058147F, 0.0F, 0.0F);
            ...
            this.setRotateAngle(EarRight, 0.06981317007977318F, -0.03490658503988659F, -0.10899999594601353F);
            ...
            this.setRotateAngle(HandLeft, 0.272999994198507F, 0.0781907508222411F, -0.19547687289441354F);
            ...
            this.setRotateAngle(FootRight, -0.469000011799553F, 0.0F, 0.0F);
            ...
            this.setRotateAngle(HandRight, 0.272999994198507F, 0.0781907508222411F, 0.19547687289441354F);
            ...
            this.Tail1.addBox(-1.1F, -0.5F, 0.0F, 2.0F, 2.0F, 1.0F, 0.0F, 0.0F, 0.0F);
            this.setRotateAngle(Tail1, 0.5167588125230802F, 0.0F, 0.0F);
            ...
            this.setRotateAngle(ThighRight, 0.2339999974051141F, 0.0F, 0.0F);
            ...
            this.setRotateAngle(ForearmRight, -0.469000011799553F, 0.0F, -0.27366763203903305F);
            ...
            this.setRotateAngle(ForearmLeft, -0.469000011799553F, 0.0F, 0.27366763203903305F);
            ...
            this.setRotateAngle(LegLeft, 0.6250000322626381F, 0.0F, 0.0F);
            ...
            this.setRotateAngle(ThighLeft, 0.2339999974051141F, 0.0F, 0.0F);
            ...
            this.setRotateAngle(Chest, 0.19099999923344946F, 0.0F, 0.0F);
            ...
            this.setRotateAngle(ArmLeft, 0.07800000190916417F, 0.0F, 0.0F);
            ...
            this.setRotateAngle(Head, -0.15700000416289628F, 0.0F, 0.0F);
            ...
            this.setRotateAngle(FootLeft, -0.469000011799553F, 0.0F, 0.0F);
            ...
            this.setRotateAngle(EarLeft, 0.06981317007977318F, -0.03490658503988659F, 0.10899999594601353F);
            ...
            this.setRotateAngle(ArmRight, 0.07800000190916417F, 0.0F, 0.0F);
            this.Snout.addChild(this.Nose);
            this.ThighRight.addChild(this.LegRight);
