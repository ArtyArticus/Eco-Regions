...
public abstract class BlueToungedSkinkModel extends ZawaBaseModel<BlueToungedSkinkEntity> {
    ...
    public static class Adult extends BlueToungedSkinkModel {
        ...
        @Override
        public void setupAnim(BlueToungedSkinkEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    public static class Child extends BlueToungedSkinkModel {
        public ModelRenderer Body;
        public ModelRenderer UpperArmLeft;
        public ModelRenderer Neck;
        public ModelRenderer UpperArmRight;
