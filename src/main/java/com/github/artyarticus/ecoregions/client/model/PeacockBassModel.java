...
public class PeacockBassModel extends SegmentedModel<PeacockBassEntity> {
    ...
    @Override
    public void setupAnim(PeacockBassEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    }
